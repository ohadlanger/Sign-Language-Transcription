...
const VideoComponent = ({ video }) => {
    ...
    return (
        <>
            <Button className={styles.secondaryButton} variant="outline-light" style={{ marginTop: '10px' }} onClick={onChangeMode}>
                {mode ? (
            ...
            <div className={styles.frameGroup}>
                ...
                {video ? (
                    <video
                        ...
                        <source src={video !== "Example" ? (mode ? URL.createObjectURL(video) : "/skeleton.mp4") : 
